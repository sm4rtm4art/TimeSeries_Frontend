...
export default function ModelTraining() {
  ...
  const modelCatalog = [
    ...
    },
    {
      ...
      bestFor: ["Multivariate data", "Complex dependencies", "Long-term forecasts"],
      metrics: {
        mape: 3.89,
        rmse: 11.76,
        mae: 8.92,
    ...
    },
    {
      ...
      bestFor: ["Feature-rich data", "Mixed frequencies", "Medium-term forecasts"],
      metrics: {
        mape: 4.12,
        rmse: 12.03,
        mae: 9.45,
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            className={`h-1.5 w-3 rounded-sm ${
              i <= Math.floor(value) ? getCharacteristicColor(value) : "bg-gray-200 dark:bg-gray-700"
            } ${i === Math.ceil(value) && i > Math.floor(value) ? "opacity-50" : "opacity-100"}`}
          />
        ))}
      </div>
    )
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={handleStartTraining} disabled={isTraining || selectedModels.length === 0}>
            {isTraining ? (
              <>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="flex items-center gap-2 rounded-md border p-3">
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground">Est. Time Remaining</div>
                    <div className="font-medium">
                      {Math.max(0, 5 - Math.floor(trainingProgress / 20))}m {30 - Math.floor(trainingProgress / 2)}s
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="flex items-center gap-2 rounded-md border p-3">
                  <Gauge className="h-5 w-5 text-green-500" />
                  <div>
                    <div className="text-xs text-muted-foreground">Best MAPE</div>
        ...
        <TabsContent value="selection" className="space-y-4 pt-4">
            ...
            <div className="flex items-center gap-2">
              <Select defaultValue="all">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="multivariate">Best for Multivariate</SelectItem>
                </SelectContent>
              </Select>
              <TooltipProvider>
                <Tooltip>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Based on your data characteristics, we recommend the following model combination
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="rounded-md bg-muted p-4">
                  ...
                  <ul className="space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Your data shows strong seasonal patterns that N-BEATS handles well</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="mt-0.5 h-4 w-4 text-green-600" />
                      <span>TiDE excels with the multivariate features you've engineered</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="mt-0.5 h-4 w-4 text-green-600" />
                      <span>Ensemble approach reduces forecast error by ~12% in similar datasets</span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="md:col-span-1">
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardDescription>Configure model parameters to optimize performance</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="auto-tune">Auto-Tuning</Label>
                      <Switch id="auto-tune" checked={autoTuneEnabled} onCheckedChange={setAutoTuneEnabled} />
                    </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="max-w-xs">Maximum time allowed for hyperparameter optimization</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </div>
                          ...
                          <AccordionContent>
                            <div className="space-y-4 pt-2">
                              <div className="space-y-2">
                                    ...
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p className="max-w-xs">
                                          Number of blocks per stack in the N-BEATS architecture
                                        </p>
                                      </TooltipContent>
                                    </Tooltip>
                                  </TooltipProvider>
                                ...
                                <div className="flex items-center gap-2">
                                  <Input type="number" min={1} max={10} defaultValue={3} className="w-20" />
                                  <Slider defaultValue={[3]} min={1} max={10} step={1} className="flex-1" />
                                </div>
                                <div className="flex justify-between text-xs text-muted-foreground">
                                  <span>Simple (1)</span>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                  <Input
                                    ...
                                    className="w-24"
                                  />
                                  <Slider defaultValue={[0.05]} min={0.001} max={0.5} step={0.001} className="flex-1" />
                                </div>
                                <div className="text-xs text-muted-foreground">
                                  Controls flexibility of the trend. Larger values allow more flexibility.
                                </div>
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                  <Input
                                    ...
                                    className="w-24"
                                  />
                                  <Slider defaultValue={[10]} min={0.01} max={10} step={0.01} className="flex-1" />
                                </div>
                                <div className="text-xs text-muted-foreground">
                                  Controls strength of seasonality. Larger values allow stronger seasonal effects.
                                </div>
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                  <Input
                                    ...
                                    className="w-20"
                                  />
                                  <Slider defaultValue={[0.1]} min={0} max={0.5} step={0.01} className="flex-1" />
                                </div>
                                <div className="text-xs text-muted-foreground">
                                  Controls regularization strength. Higher values help prevent overfitting.
                                </div>
                              </div>
                          ...
                          <AccordionContent>
                            <div className="space-y-4 pt-2">
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                  <Input type="number" min={1} max={10} defaultValue={4} className="w-20" />
                                  <Slider defaultValue={[4]} min={1} max={10} step={1} className="flex-1" />
                                </div>
                              </div>
            ...
            <div className="md:col-span-2">
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardDescription>See how parameter changes affect model performance</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="h-[400px] w-full rounded-md border p-4">
                    <div className="flex h-full w-full items-center justify-center">
                      <div className="text-center text-muted-foreground">
                        ...
                        <p className="text-sm">Adjust parameters to see their effect on model performance</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="rounded-md bg-muted p-4">
                      <h4 className="mb-2 font-medium">Parameter Sensitivity</h4>
                      <div className="space-y-3">
                        <div>
                          <div className="mb-1 flex items-center justify-between text-sm">
                            <span>Number of Blocks</span>
                            <span className="text-blue-600 dark:text-blue-400">High Impact</span>
                          </div>
                        ...
                        <div>
                          <div className="mb-1 flex items-center justify-between text-sm">
                            ...
                            <span className="text-blue-600 dark:text-blue-400">Medium Impact</span>
                          </div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="mt-2 rounded-md bg-blue-50 p-2 text-blue-800 dark:bg-blue-900 dark:text-blue-100">
                          <div className="flex items-start gap-1">
                            ...
                            <span>
                              Based on your data characteristics, we recommend using 3 blocks with 128 hidden units
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        <TabsContent value="results" className="space-y-4 pt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select defaultValue={selectedExperiment} onValueChange={setSelectedExperiment}>
                <SelectTrigger className="w-[180px]">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle>
                        Experiment Results: {experiments.find((e) => e.id === selectedExperiment)?.model} -{" "}
                        {experiments.find((e) => e.id === selectedExperiment)?.name}
                      </CardTitle>
                      <CardDescription>
                        Run on {experiments.find((e) => e.id === selectedExperiment)?.timestamp}
                      </CardDescription>
                    </div>
                    <Badge className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100">
                      Best Run
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div className="rounded-md border p-4">
                      <div className="mb-1 text-sm text-muted-foreground">MAPE</div>
                      <div className="text-2xl font-bold">
                        {experiments.find((e) => e.id === selectedExperiment)?.mape}%
                      </div>
                      <div className="mt-1 text-xs text-green-600">12% better than baseline</div>
                    </div>
                    <div className="rounded-md border p-4">
                      <div className="mb-1 text-sm text-muted-foreground">RMSE</div>
                      <div className="text-2xl font-bold">
                        {experiments.find((e) => e.id === selectedExperiment)?.rmse}
                      </div>
                      <div className="mt-1 text-xs text-green-600">8% better than baseline</div>
                    </div>
                    <div className="rounded-md border p-4">
                      <div className="mb-1 text-sm text-muted-foreground">MAE</div>
                      <div className="text-2xl font-bold">
                        {experiments.find((e) => e.id === selectedExperiment)?.mae}
                      </div>
                      <div className="mt-1 text-xs text-green-600">7% better than baseline</div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md bg-muted p-4">
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm md:grid-cols-3">
                      <div className="flex items-center justify-between">
                        <span className="text-muted-foreground">Number of Blocks:</span>
                        <span>3</span>
                      </div>
                      <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 gap-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Compare performance across different models and configurations</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b">
                          ...
                          <th className="pb-2 text-left font-medium">Configuration</th>
                      ...
                      <tbody>
                        {experiments.map((exp) => (
                          <tr
                            key={exp.id}
                            className={`border-b ${exp.id === "exp-3" ? "bg-green-50 dark:bg-green-900/20" : ""}`}
                          >
                  ...
                  <div className="mt-6 h-[400px] w-full">
                    <div className="flex h-full w-full items-center justify-center">
                      <div className="text-center text-muted-foreground">
                        ...
                        <p className="text-sm">Showing forecast results from all selected models</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="rounded-md bg-muted p-4">
                      <h4 className="mb-2 font-medium">Parameter Differences</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center justify-between">
                          <span>Number of Blocks:</span>
                          <div>
                            <span className="mr-2 text-muted-foreground">Baseline: 2</span>
                            <span className="font-medium text-green-600">Tuned-2: 3</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Hidden Layer Units:</span>
                          <div>
                            <span className="mr-2 text-muted-foreground">Baseline: 64</span>
                            <span className="font-medium text-green-600">Tuned-2: 128</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Learning Rate:</span>
                          <div>
                            <span className="mr-2 text-muted-foreground">Baseline: 0.01</span>
                            <span className="font-medium text-green-600">Tuned-2: 0.001</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-md bg-muted p-4">
                      <h4 className="mb-2 font-medium">Improvement Analysis</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center justify-between">
                          <span>MAPE Improvement:</span>
                          <span className="font-medium text-green-600">-8.6%</span>
                        </div>
                        <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-medium text-green-600">-7.6%</span>
                        </div>
                        <div className="mt-2 rounded-md bg-blue-50 p-2 text-blue-800 dark:bg-blue-900 dark:text-blue-100">
                          <div className="flex items-start gap-1">
                            <Info className="mt-0.5 h-4 w-4 flex-shrink-0" />
                            <span>
                              The most significant improvement came from increasing the number of blocks and reducing
                              the learning rate
                            </span>
                          </div>
                        </div>
